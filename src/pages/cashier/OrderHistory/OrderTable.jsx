...
import { EyeIcon, IndianRupee, Printer } from "lucide-react";
...
function OrderTable({handleViewOrderDetails}) {
  return (
    <div>
                ...
                {orders.map((order, i) => (
                  ...
                  >
                    ...
                    <TableCell>{order.customer.fullName}</TableCell>
                     <TableCell className={"flex items-center"}><IndianRupee className="w-3 h-3 mt-0.5"/>{(order.totalAmount).toFixed(2)}</TableCell>
