...
import { createInventory, getAllInventory, getInventoryById, updateInventory } from "./inventoryThunk";
    ...
    extraReducers: (builder)=>{
        ...
        .addCase(createInventory.pending, (state) => {
              ...
              .addCase(updateInventory.fulfilled, (state, action) => {
                state.loading = false;
                const idx = state.inventories.findIndex((e) => e.id === action.payload.id);
